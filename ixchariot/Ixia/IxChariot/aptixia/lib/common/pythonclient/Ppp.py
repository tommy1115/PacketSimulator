...
class Ppp( XProtocolObject.XProtocolObject ):
	# Class Properties
	...
	def __init__( self, parent, objectId=None, transactionContext=None, preFetch=False):
		super( Ppp, self ).__init__(parent, objectId, transactionContext, preFetch)
		# defaults
		if not self.isInstantiated:
			self.managedProperties["lcpTimeout"] = 15
			self.managedProperties["lcpRetries"] = 3
			...
			self.managedProperties["lcpTermRetries"] = 3
			...
			self.managedProperties["ncpRetries"] = 3
			self.managedProperties["authTimeout"] = 15
			self.managedProperties["authRetries"] = 3
