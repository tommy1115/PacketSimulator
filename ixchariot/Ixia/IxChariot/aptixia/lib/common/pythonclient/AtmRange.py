...
class AtmRange( XProtocolObject.XProtocolObject ):
	...
	def _get_encapsulation (self):
		return self.getVar ("encapsulation")
	def _set_encapsulation (self, value):
		self.setVar ("encapsulation", value)
	encapsulation = property (_get_encapsulation, _set_encapsulation, None, "encapsulation property")
	def _get_mac (self):
	...
	def __init__( self, parent, objectId=None, transactionContext=None, preFetch=False):
		super( AtmRange, self ).__init__(parent, objectId, transactionContext, preFetch)
		# defaults
		if not self.isInstantiated:
			self.managedProperties["name"] = "atm-"
			self.managedProperties["encapsulation"] = "1"
